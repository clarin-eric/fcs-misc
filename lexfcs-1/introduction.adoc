...
The _Federated Content Search for Lexical Resources (LexFCS)_ specification is an extension of the <<ref:CLARIN-FCSCore2,_CLARIN Federated Content Search (CLARIN-FCS) - Core 2_>> specification that allows search and retrieval of _lexical resources_ including dictionaries, encyclopedias, normative data, terminological databases, ontologies etc.
...
NOTE: Based on _Glossary_ in <<ref:CLARIN-FCSCore2,FCS Core 2>> specification.
...
SRU::
    <<ref:OASIS-SRU-Overview,Search and Retrieve via URL>> is a protocol for Internet search queries. Originally introduced by Library of Congress <<ref:LOC-SRU12>>, later standardisation process moved to OASIS <<ref:OASIS-SRU12>>, <<ref:OASIS-SRU20>>.


== Normative References

NOTE: Based on _Normative References_ in <<ref:CLARIN-FCSCore2,FCS Core 2>> specification.
...
[[ref:CLARIN-FCSCore2]]CLARIN-FCSCore2::
    CLARIN Federated Content Search (CLARIN-FCS) - Core 2 specification, SCCTC FCS Task-Force,
    https://www.clarin.eu/content/federated-content-search-core-specification,
    https://github.com/clarin-eric/fcs-misc/tree/main/fcs-core-2[(Sources)],
    https://clarin-eric.github.io/fcs-misc/fcs-core-2-specs/fcs-core-2.html[(HTML Build)],
    https://clarin-eric.github.io/fcs-misc/fcs-core-2-specs/fcs-core-2.pdf[(PDF Build)],
...
* `string`
+
The literal _string_ as the content of an element or value of an attribute.
...
For a list of common XML namespace names and prefixes see the table "XML Namespaces and prefixes" in Section 1.5 of the <<ref:CLARIN-FCSCore2,FCS Core 2 Specification>>.
